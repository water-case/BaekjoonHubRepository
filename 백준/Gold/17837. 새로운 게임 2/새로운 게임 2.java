...
public class Main {
    ...
    static class Pos {
        ...
        public void addList(Piece piece, ArrayList<Piece> list) {
            boolean chk = false;
        ...
        public void addReverseList(Piece piece, ArrayList<Piece> list) {
    ...
    private static boolean nextTime() {
        for(int i=0; i<K; i++) {
            ...
            switch (caseNum) {
                case 0:
                    map[dx][dy].addList(nowPiece, nowPos.list);
                    break;
                case 1:
                    map[dx][dy].addReverseList(nowPiece, nowPos.list);
                    break;
                case 2:
